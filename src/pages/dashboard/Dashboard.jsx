      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {Object.entries(byCategory).sort((a, b) => b[1].count - a[1].count).map(([cat, data]) => (
          <div key={cat} className="p-3 bg-surface-secondary rounded-lg">
            ...
            <p className="text-xs text-brand-charcoal">across active proummary Widget âââââââââââââââââââââââââââââââââââââââââââââââââ
function BenefitsSummaryWidget({ companyId }) {
  const [benefits, setBenefits] = useState([])
  const [loading, setLoading] = useState(true)
